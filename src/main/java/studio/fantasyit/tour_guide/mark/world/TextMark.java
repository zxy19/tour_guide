...
public record TextMark(Component text, Vec3 pos, int color) implements IMark {
    ...
    public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(TourGuide.MODID, "text");
    ...
    public static TextMark fromNetwork(FriendlyByteBuf buf) {
        return new TextMark(buf.readJsonWithCodec(ComponentSerialization.CODEC), new Vec3(buf.readDouble(), buf.readDouble(), buf.readDouble()), buf.readInt());
    }
